...
class TrainerLabel_yml():
	...
	def detect(self, image_array, _id_):
		faces = self.casc.detectMultiScale(image_array, scaleFactor=1.4, minNeighbors=5)
	...
	def color_space_module(self, ext, _root, _dirs, _file):
		...
		GRAY_cv = cv2.cvtColor(temp_img, cv2.COLOR_RGB2GRAY)
